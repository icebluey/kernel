...
install -m 0755 -d kernel/kernel-"${_kver}".el8.x86_64-repos/packages
install -m 0755 -d kernel/assets
sleep 1
cd kernel/kernel-"${_kver}".el8.x86_64-repos/packages/
...
sleep 2
cd ..
tar -zcvf assets/kernel-"${_kver}".el8.x86_64-repos.tar.gz kernel-"${_kver}".el8.x86_64-repos
